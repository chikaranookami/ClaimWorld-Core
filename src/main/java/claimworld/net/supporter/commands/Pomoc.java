...
public class Pomoc {
    ...
    public Pomoc() {
        ...
        helpMessages.add("§8Dolary\n\nTo glowna waluta serwera.\n\nMozesz ja zdobyc:\n§c+§8 U Bankiera na spawnie\n§c+§8 W Skrzyniach Smoka\n§c+§8 u Niestandardowych Handlarzy, ktorzy pojawiaja sie co jakis czas");
